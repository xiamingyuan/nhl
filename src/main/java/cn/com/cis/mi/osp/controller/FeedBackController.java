...
public class FeedBackController {
    ...
    @RequiresPermissions("memberfeedback:list")
    @ResponseBody
    public Object getfeedbacklist(String sdate, String edate, String loginName, String realName, String content, int page,int start, int limit, String sort) throws Exception {
        Result result;
