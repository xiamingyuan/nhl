...
<div ui-layout="{dividerSize:0}" class="layout-domain" localstorage layout-loaded-grid-position>
    <div ui-layout-container size="30px" ><span breadcrumb data-title="财务账单确认"></span></div>
        ...
        <table class="search-table" enter-submit>
            <tr>
                ...
                <td class="search-btns-td" valign="top">
                    ...
                    <shiro:hasPermission name="financebill:export">
...
<%--填写到账时间弹窗--%>
<div id="timeModal"  class="modal" style=" display: none;" tabindex="-1" role="dialog" aria-labelledby="timeModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"  aria-hidden="true">×</button>
        <h4 id="timeModalLabel">财务账单确认</h4>
    </div>
    <div class="modal-body reset-modal-body" style="width: 400px;">
        <div class="form-inline" style="padding: 15px;">
            <div class="form-group">
                <label>到账日期:</label>
                <div class="btn-group input-append date form-datetime" datepicker-bottom>
                    <input size="16" type="text" class="datepicker-input" readonly ng-model="accountTime"/>
                    <span class="add-on"><i class="icon-remove"></i></span>
                    <span class="add-on hidden add-icon-calendar"><i class="icon-calendar"></i></span>
                </div>
            </div>
    ...
    <div class="modal-footer page-container second-btns-group second-modal-btns">
        <div class="pull-right">
            <button type="button" class="btn blue" data-dismiss="modal"  ng-click="billAudit();">确定</button>
            <button type="button" class="btn blue" data-dismiss="modal"  aria-hidden="true">取消</button>
        </div>
    </div>
</div>
