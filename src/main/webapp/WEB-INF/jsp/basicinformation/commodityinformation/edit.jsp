...
<form name="edit" novalidate class="form-default" ng-controller="commodityInformationEditController">
    <div ui-layout="{dividerSize:0}" enter-submit class="ui-layout-background">
        <div ui-layout-container size="30px"><span breadcrumb data-title="商品信息编辑"></span></div>
                ...
                <div class="form-inline" >
                    <div class="form-group pull-left">
                        ...
                        <div class="form-group text-error-height">
                            ...
                            <input class="span6" name="name" type="text" ng-model="list.name" required />
                            <div ng-show="edit.$submitted || edit.drugName.$touched">
                                <span class="error-shorter-info" ng-show="edit.drugName.$error.required">通用名不允许为空！</span>
                            </div>
                        </div>
                        <div class="form-group text-label-default">
                        ...
                        <div class="form-group text-label-default">
                            ...
                            <select class="span2" name="typeOne" ng-model="list.typeOne" ng-change="typeOneChange()">
                                <option value="">--</option>
                                <option ng-repeat="item in typeOneList" value="{{item.id}}">
                                    {{item.name}}
                                </option>
                            </select>
                            <select class="span2" name="typeTwo" ng-model="list.typeTwo" ng-change="typeTwoChange()">
                                <option value="">--</option>
                                <option ng-repeat="item in typeTwoList" value="{{item.id}}" data-parentid={{item.parentId}}>{{item.name}}</option>
                            </select>
                            <select class="span2" name="typeThree" ng-model="list.typeThree">
                                <option value="">--</option>
                                <option ng-repeat="item in typeThreeList" value="{{item.id}}" data-parentid={{item.parentId}}>{{item.name}}</option>
                            </select>
                        </div>
                        <div class="form-group text-error-height">
                            <label class="control-smaller-label">剂型：</label>
                            <input class="span6" name="dosage" type="text" ng-model="list.dosage" required />
                            <div ng-show="edit.$submitted || edit.dosage.$touched">
                                <span class="error-shorter-info" ng-show="edit.dosage.$error.required">剂型不允许为空！</span>
                            </div>
                        </div>
                        <div class="form-group text-error-height">
                            ...
                            <div ng-show="edit.$submitted || edit.specification.$touched">
                                <span class="error-shorter-info" ng-show="edit.specification.$error.required">规格不允许为空！</span>
                            </div>
                        </div>
                        <div class="form-group text-error-height">
                            <label class="control-smaller-label">单位：</label>
                            <input class="span6" name="unit" type="text" ng-model="list.unit" required />
                            <div ng-show="edit.$submitted || edit.unit.$touched">
                                <span class="error-shorter-info" ng-show="edit.unit.$error.required">单位不允许为空！</span>
                            </div>
                        </div>
                        <div class="form-group text-label-default">
                        ...
                        <div class="form-group text-error-height">
                            ...
                            <div ng-show="edit.$submitted || edit.barcode.$touched">
                                <span class="error-shorter-info" ng-show="edit.barcode.$error.required">条形码不能为空！</span>
                                <span class="error-shorter-info" ng-show="edit.barcode.$error.pattern">条形码为13位数字！</span>
                            </div>
                        </div>
                        <div class="form-group text-error-height">
                            ...
                            <div ng-show="edit.$submitted || edit.singleMaxClaim.$touched">
                                <span class="error-shorter-info" ng-show="edit.singleMaxClaim.$error.pattern" style="margin-left:80px;">月限量最大不能超出3位正整数！</span>
                            </div>
                        </div>
                        <div class="form-group text-error-height">
                            ...
                            <div ng-show="edit.$submitted || edit.manufactEnterprise.$touched">
                                <span class="error-shorter-info" ng-show="edit.manufactEnterprise.$error.required">生产企业不允许为空！</span>
                            </div>
                        </div>
                        <div class="form-group text-label-default">
                            ...
                            <div class="span6" style="margin-left: 0;">
                                <label class="radio-group pull-left">
                                    <input type="radio" name="isExistRegulateCode" value="1" ng-click="isExistRegulateCode('1')"/>
                                ...
                                <div class="form-group text-error-height pull-left">
                                    ...
                                    <div ng-show="isCheckExistRegulateCode && (edit.$submitted || edit.regulatecodePrefix.$touched)">
                                        <span class="error-shorter-info" ng-show="edit.regulatecodePrefix.$error.pattern" style="margin-left: 105px;">电子监管码前7位！</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div ui-layout-container size="34px" class="second-btns-group">
            <div class="pull-left">
                <button type="submit" class="btn blue enter-default" ng-click="uploadImg(edit.$valid)">保存</button>
            </div>
...
<script type="text/javascript">
    ...
    $("#formIframe").load(function () {
        ...
        var appElement = document.querySelector('[ng-controller=commodityInformationEditController]');
        var $scope = angular.element(appElement).scope();
        if(msgObj.fileName){
            $scope.list.picUrl = msgObj.fileName;
            $scope.update($scope.edit.$valid);
        }else{
