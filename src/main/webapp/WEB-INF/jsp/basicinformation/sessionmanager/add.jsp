...
<form name="add" novalidate class="form-default">
    <div ui-layout="{dividerSize:0}" enter-submit class="ui-layout-background">
        <div ui-layout-container size="30px"><span breadcrumb data-title="话术添加"></span></div>
            ...
            <div class="consult-form-position">
                <div class="form-inline">
                    <div class="form-group text-error-height">
                        ...
                        <div ng-show="add.$submitted || add.caption.$touched">
                            <span class="error-shorter-info" ng-show="add.caption.$error.required">标题不允许为空！</span>
                        </div>
                    </div>
                </div>
                <div class="form-inline">
                ...
                <div class="form-inline">
                    <div class="form-group text-error-height">
                        <label class="control-smaller-label">显示顺序：</label>
                        <input type="text" class="form-control span6" name="orderNum" ng-model="list.orderNum" ng-pattern="/^[0-9]{1,}$/"/>
                        <div ng-show="add.$submitted || add.orderNum.$touched">
                            <span class="error-shorter-info" ng-show="add.orderNum.$error.pattern">显示顺序为正整数！</span>
                        </div>
                    </div>
                </div>
                <div class="form-inline">
                    <div class="form-group text-label-default">
                        ...
                        <div class="span6" style="margin-left: 0;">
                            ...
                            <div class="form-group">
                                <label class="control-smaller-label">类别：</label>
                ...
                <div class="form-inline">
                    <div class="form-group textarea-error-height clear-both">
                        ...
                        <div ng-show="add.$submitted || add.content.$touched">
                            <span class="error-shorter-info" ng-show="add.content.$error.required">内容不允许为空！</span>
                        </div>
                    </div>
                </div>
        ...
        <div ui-layout-container size="34px" class="second-btns-group">
            <div class="pull-left">
                <button type="submit" class="btn blue enter-default" ng-click="save(add.$valid)">保存</button>
            </div>
