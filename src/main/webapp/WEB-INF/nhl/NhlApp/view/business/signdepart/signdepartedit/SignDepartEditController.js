...
Ext.define('NhlApp.view.business.signdepart.signdepartedit.SignDepartEditController', {
    extend: 'Ext.app.ViewController',
    requires: [

    ],
    alias: 'controller.business_signdepartedit',
    afterrender:function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response, options) {
                ...
                if(data.code==200){
                    var provincecode = data.data.result.hospital_province_id;
                    var cityStore = Ext.getCmp('cityEdit').getStore();
                    cityStore.getProxy().extraParams = {
                        parentId:provincecode
                    };
                    cityStore.load();
                    vm.setData({editsigndepart:data.data.result})
                }
            }
        });
    },
                ...
                imageForm.submit({
                    ...
                    failure: function(response, options) {
                        ...
                        if(data.code == 200){
                            ...
                            vm.data.editsigndepart.url = url;
                            me.trueSave(vm.data.editsigndepart)
                        }
                    }
                });
            }else{
