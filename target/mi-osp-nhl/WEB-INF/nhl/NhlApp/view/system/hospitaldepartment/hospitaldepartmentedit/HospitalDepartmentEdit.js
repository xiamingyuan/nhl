 ...
 */
Ext.define('NhlApp.view.system.hospitaldepartment.hospitaldepartmentedit.HospitalDepartmentEdit', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.hospitaldepartmentedit',
    requires: [
        'NhlApp.view.system.hospitaldepartment.hospitaldepartmentedit.HospitalDepartmentEditController',
        'NhlApp.view.system.hospitaldepartment.hospitaldepartmentedit.HospitalDepartmentEditModel'
    ],
    controller: 'system_hospitaldepartmentedit',
    viewModel: {
        type:'system_hospitaldepartmentedit'
    },
    iconCls:'fa fa-home',
    title: '当前位置 : 医院及科室编辑',
    scrollable:'y',
