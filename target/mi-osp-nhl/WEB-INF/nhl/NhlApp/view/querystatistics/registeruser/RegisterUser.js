...
Ext.define('NhlApp.view.querystatistics.registeruser.RegisterUser', {
    extend: 'Ext.grid.Panel',
    xtype: 'pivotgrid',
    controller: 'pivotlayout',

    requires: [
        'NhlApp.view.querystatistics.registeruser.Sales',
        'NhlApp.view.querystatistics.registeruser.LayoutController'
    ],
