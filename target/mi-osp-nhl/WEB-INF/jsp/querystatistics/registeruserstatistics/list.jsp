...
<div ui-layout="{dividerSize:0}" class="layout-domain" layout-loaded-grid-position>
    <div ui-layout-container size="30px" >
        <span breadcrumb data-title="注册用户统计"></span>
    </div>
    <div ui-layout-container size="230px" class="grid-container" ui-layout-loaded>
                ...
                <table class="search-table" enter-submit>
                    <tr>
                        ...
                        <td class="search-btns-td" valign="top" style="width:110px;">
                            ...
                            <shiro:hasPermission name="reguserstatis:export">
         ...
         <div ui-layout="{dividerSize:0}">
             <div ui-layout-container size="38px" style="overflow: hidden;">
                 <ul class="nav nav-tabs nav-tabs-padding" id="myTab">
                     <li class="active"><a>注册用户统计图</a></li>
                 </ul>
             </div>
             <div ui-layout-container="central" style="background-color: #F9F9FF;">
                 <div class="tab-content">
                     <div class="tab-pane active outerWarpi" id="registeUsersChart" style="position: absolute;top:0;right:0;bottom:0;left:0;background-color: #FFF;">
                     </div>
                 </div>
             </div>
         </div>
...
<!--导出所用form-->
<form action="exportuserstatistics" style="display: none;" method="get">
    <input type="hidden" name="qStatus" ng-modal="queryList.qStatus"/>
    <input type="hidden" name="sdate" ng-modal="queryList.sdate"/>
    <input type="hidden" name="edate" ng-modal="queryList.edate"/>
