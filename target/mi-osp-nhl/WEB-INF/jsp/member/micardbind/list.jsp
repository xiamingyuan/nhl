...
<div ui-layout="{dividerSize:0}" class="layout-domain" style="overflow-y: hidden;" layout-loaded-grid-position localstorage>
    <div ui-layout-container size="30px" >
        <span breadcrumb data-title="医保绑定"></span>
    </div>
    ...
    <div ui-layout-container="central" class="grid-container tab-content-container" ui-layout-loaded>
        <div class="tab-content">
            <div ui-layout="{dividerSize:0}" class="tab-pane active outerWarpi" id="stayExamine" ui-layout-loaded>
            ...
            <div ui-layout="{dividerSize:0}" class="tab-pane outerWarpi" id="alreadyExamine" ui-layout-loaded>
                <div ui-layout-container="central" class="grid-container" ui-layout-loaded>
                    <table class="search-table" enter-submit>
                        <tr>
                            <td class="search-options-td">
...
<!--实名认证审核-->
<div id="MICardBindModal" class="modal" style=" display: none;" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 id="detailModalLabel">审核医保卡绑定</h4>
    </div>
        ...
        <form class="form-inline">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td ng-bind="moduleLoad.loginname" class="attribute"></td>
                    <td class="textTitle">姓名：</td>
                    <td ng-bind="moduleLoad.realname" class="attribute"></td>
                </tr>
                <tr >
                    <td class="textTitle">医保地区：</td>
                    <td class="attribute">
                        <select class="form-control input-sm" id="InsuranceAreaName" style="height: 25px;width:135px; padding: 0;" ng-options="i.id as i.name for i in MICardregion" ng-model="moduleLoad.InsuranceAreaId">
                        </select>
                    </td>
                    <td class="textTitle">医保类型：</td>
                    <td class="attribute">
                        <select class="form-control input-sm " style="height: 25px; width: 145px; padding: 0;" ng-model="MICardType"  >
                            <option value="{{'0'+($index+1)}}" ng-repeat=" t in MICardTypeList">{{t}}</option>
                            <option value="99">其他</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="textTitle">医保账号：</td>
                    <td class="attribute" ng-bind="moduleLoad.insuranceNo"></td>
                    <td class="textTitle">申请时间：</td>
                    <td class="attribute" ng-bind="moduleLoad.createtime|date:'yyyy-MM-dd HH:mm'"></td>
                </tr>
                </tbody>
            </table>
        </form>
    ...
    <div class="modal-footer second-modal-btns" style="height:82px;">
        <div class="realFormBox clearfix" style="padding: 5px 20px;">
            <div class="pull-left">
                ...
                <input type="button" class="btn red" ng-click="auditSave($event,3)" value="医保卡已锁定" />
            </div>
        </div>
        <div class="realFormBox clearfix" style="padding: 5px 20px;">
            <div class="pull-left">
                <input type="button" flag="other"  class="btn red btn-success" style="float:left;" ng-click="auditSave($event,3)" value="其他原因" />
                ...
                <%--<b data-prompt class="allTipsMsg" id="allTipsMsg" ng-bind="Tips"></b>--%>
            </div>
        </div>
