        ...
        <div ui-layout-container="central"
            ...
            <div class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input class="span5" type="text" name="title" class="error-info" ng-model="msgPlan.title" required>
                        <div style="height: 0">
                            <div ng-show="messageedit.$submitted || messageedit.title.$touched">
                                <span class="error-shorter-info" style="font-size: 12px;margin-left: 20px"
                                      ng-show="messageedit.title.$error.required">请输入消息标题！</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <%--<input type="text" id="datetimepicker" ui-date-format="yyyy-mm-dd hh:mm"--%>
                               <%--class="input-large form-control" name="publishTime" ng-change="dateChange()"--%>
                               <%--ng-model="publishTime" readonly required>--%>
                        ...
                        <div style="height: 0">
                            <div ng-show="messageedit.$submitted || messageedit.publishTime.$touched">
                                <span class="error-shorter-info" style="font-size: 12px;margin-left: 20px"
                                      ng-show="messageedit.publishTime.$error.required">请选择发送时间！</span>
                            </div>
                            <div ng-show="isReminder">
                                <span class="error-shorter-info" style="font-size: 12px;margin-left: 20px" ng-show="isReminder">发送时间不可早于当前时间！</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-inline" id="isAllUser">
                        <label class="control-label" style="text-align:left;cursor: pointer;">
                            <input type="radio" style="vertical-align: middle;margin-bottom: 3px"
                                   name="isAllUser" value="1" ng-model="assign" ng-click="clearSelCount()">所有用户
                        </label>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-group" style="width:100%">
                    ...
                    <textarea style="height: 360px;width:90%;resize: none;padding: 4px 6px;" id="container"
                              name="content" ng-model="msgPlan.content"></textarea>
                </div>
            </div>
        </div>
        <div ui-layout-container size="34px" class="second-btns-group" style="background: initial;">
            <div class="pull-left">
                <button type="submit" class="btn blue enter-default" ng-click="editMsg(messageedit.$valid);">保存</button>
            </div>
...
<div id="myModal" class="modal" style="display: none;top:100px" tabindex="-1" role="dialog"
            ...
            <form class="form-inline pull-left  searchForm" enter-submit>
                <div class="pull-left">
                    <label class="input">用户名：
                        <input type="text" class="input-medium" ng-model="userName">
                    </label>&nbsp;&nbsp;
                    <label class="input">身份证号：
                        <input type="text" class="input-medium" ng-model="idnumber">
                    </label>&nbsp;&nbsp;
                </div>
                <div class="pull-right">
                    <button type="button" class="btn blue enter-default" ng-click="pagerOptions.search()">查询</button>
                </div>
            </form>
        </div>
        <div class="page-container">
            <div ui-grid="grid" ui-grid-resize-columns ui-grid-selection ui-grid-auto-resize></div>
        </div>
    </div>
