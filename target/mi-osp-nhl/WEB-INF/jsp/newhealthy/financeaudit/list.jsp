...
<div ui-layout="{dividerSize:0}" class="layout-domain" localstorage layout-loaded-grid-position>
    <div ui-layout-container size="30px" ><span breadcrumb data-title="财务审核"></span></div>
            ...
            <tr>
                <td class="search-options-td">
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <label>会员:</label>
                            <input type="text" ng-model="searchParams.recognizee" class="input-small" />
                        </div>
                        <div class="form-group">
                            <label>商品名称:</label>
                            <input type="text" ng-model="searchParams.goodsName" class="input-small" />
                        </div>
                        ...
                        <div class="form-group">
                            <label>供应商审核:</label>
                            <select ng-model="searchParams.providerStatus" class="input-small">
                        ...
                        <div class="form-group">
                            <label>财务审核:</label>
                            <select ng-model="searchParams.auditStatus" class="input-small">
                                <option value="">全部</option>
                ...
                <td class="search-btns-td" valign="top" style="width: 130px;">
                    ...
                    <shiro:hasPermission name="financialaudit:deal">
                        <button type="button" class="btn red" ng-click="AllPassas(0)">全部同意</button> 
                    </shiro:hasPermission>
...
<form class="form-horizontal css-form" name="reimburse" novalidate>
    <div id="viewModal" class="modal" style=" display: none;" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel"
        ...
        <div class="modal-body">
            <textarea id="apphear_notext" name="businessReason" ng-model="businessReason" style="padding: 0px 5px;"></textarea>
        </div>
        <div class="modal-footer second-modal-btns">
            <div class="pull-right">
                <button type="submit" class="btn blue" ng-click="financialAudit(0)">确定</button>
