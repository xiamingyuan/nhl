...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('click', '.sidebar-toggler', function (e) {
            ...
            var sidebar = $('.page-sidebar');
            //获取angular中方法
            var appElement = document.querySelector('[ng-controller=bodyCtrlController]');
            ...
            if (body.hasClass("page-sidebar-closed")) {
                body.removeClass("page-sidebar-closed");
                $(this).removeClass('toggler_right')
                if (body.hasClass('page-sidebar-fixed')) {
                    sidebar.css('width', '');
                }
            } else {
                body.addClass("page-sidebar-closed");
                $(this).addClass('toggler_right');
            }
    ...
    var  handlerLeaveTwoMenu= function () {
        ...
        $(".page-sidebar-menu .sub-menu>li").on("click","a",function(){
            var parent = $(this).parent();
            $(".sub-menu li").removeClass("active");
            parent.addClass("active");
            window.localStorage.clear();//消除切换的标签中有相同name的查询条件
        });
    ...
    var handleTheme = function () {
        ...
        //    $('#style_color').attr("href", "../app/Content/common/" + color + ".css");
